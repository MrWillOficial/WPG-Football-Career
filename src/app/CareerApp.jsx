    ...
    <div className="app-root">
      ...
      {phase === 'copa-junior-mid-match' && copaJuniorMidState?.pendingMatch && (
        <MatchScreen
          ...
          clubsMap={{ ...ALL_CLUBS_MAP, [COPINHA_OWN_ID]: { id: COPINHA_OWN_ID, name: COPINHA_OWN_NAME, overall: player.overall } }}
          preMatchCondition={100}
          onContinue={continueCopaJuniorMidMatch}
        />
      )}
      {phase === 'copa-junior-mid-result' && copaJuniorMidState?.result && <CopaJuniorMidResultScreen copaJuniorMidState={copaJuniorMidState} onContinue={finishCopaJuniorMid} />}
        ...
        <WPGShell active={tab} onChange={setTab} player={player} club={club} seasonYear={seasonYear}>
          ...
          {tab === 'profile' && (
            <PlayerProfileScreen
              ...
              onRequestTransfer={requestTransfer} onRequestLoan={requestLoan} onRequestRaise={requestRaise} onInvest={handleInvest} onWithdrawInvestments={handleWithdrawInvestments} onBuyProperty={handleBuyProperty} onReset={resetCareer}
            />
          )}
